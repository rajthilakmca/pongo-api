...
function compareBytes(bytes, expectedArray) {
    const expectedBytes = Uint8Array.from(expectedArray);
    getChai_1.expect(bytes).to.deep.equal(expectedBytes);
}
let Waves;
let Base58;
let Bool;
...
describe('ByteProcessor', () => {
    ...
    describe('Base58', () => {
        ...
        it('should throw when given a non-Base58 string', () => {
            getChai_1.expect(() => processor.process('StV1DL6CwTryKyV%')).to.throw();
        });
    });
    describe('Bool', () => {
        beforeEach(() => {
        ...
        it('should throw when given not a boolean value', () => {
            getChai_1.expect(() => processor.process(1)).to.throw();
            getChai_1.expect(() => processor.process(0)).to.throw();
            getChai_1.expect(() => processor.process(null)).to.throw();
            getChai_1.expect(() => processor.process('')).to.throw();
        });
    });
    describe('Byte', () => {
        beforeEach(() => {
        ...
        it('should throw when given not a byte value', () => {
            getChai_1.expect(() => processor.process('')).to.throw();
            getChai_1.expect(() => processor.process(true)).to.throw();
            getChai_1.expect(() => processor.process(null)).to.throw();
            getChai_1.expect(() => processor.process(256)).to.throw();
            getChai_1.expect(() => processor.process(144125)).to.throw();
            getChai_1.expect(() => processor.process(12141209481023)).to.throw();
        });
    });
    describe('Long', () => {
        beforeEach(() => {
...
//# sourceMappingURL=ByteProcessor.spec.js.map